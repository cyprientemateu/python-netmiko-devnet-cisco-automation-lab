...
def render_and_save_configs(interfaces, device_host, timestamp):
    ...
    Execution mode is stamped in the file header.
    ...
    try:
        ...
        with open(config_file, "w", encoding="utf-8") as f:
            f.write(f"! Generated by NetDevOps Framework V6\n")
...
def main():
    ...
    log.info("=" * 60)
    log.info(f"NetDevOps Framework V6 — {EXECUTION_MODE} MODE")
    log.info("=" * 60)
    ...
    for device in devices:
        ...
        if args.dry_run:
            log.warning(
                "DRY-RUN MODE — remediation skipped, no changes pushed"
            )
        else:
    ...
    log.info("=" * 60)
    log.info("NetDevOps Framework V6 — Execution Complete")
    log.info("=" * 60)
