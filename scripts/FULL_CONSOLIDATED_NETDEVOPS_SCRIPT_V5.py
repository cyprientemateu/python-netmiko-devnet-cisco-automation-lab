...
# =========================
# 5. RENDER AND SAVE CONFIGS
#    NEW IN V5.
#    Renders every interface through the Jinja2 template
#    and saves the full output to configs/generated/
#    BEFORE any deployment occurs.
#
#    This gives:
#    - A human-readable record of intended changes
#    - A dry-run foundation (review before pushing)
#    - A rollback reference
#    - A config archival trail
# =========================
def render_and_save_configs(interfaces, device_host, timestamp):
    """
    Renders each interface config using the Jinja2 template
    and saves the full output to configs/generated/.
    ...
    try:
        ...
        with open(config_file, "w", encoding="utf-8") as f:
            f.write(f"! Generated by NetDevOps Framework V5\n")
...
def generate_html_report(
    compliance, diff_report, device_host, config_file, filename
):
...
def main():
    ...
    log.info("=" * 50)
    log.info("NetDevOps Framework V5 — Execution Started")
    log.info("=" * 50)
    ...
    log.info("=" * 50)
    log.info("NetDevOps Framework V5 — Execution Complete")
    log.info("=" * 50)
